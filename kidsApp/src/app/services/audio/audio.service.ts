...
export class AudioService {
    ...
    constructor(public nativeAudio: NativeAudio, platform: Platform, public alert: AlertService) {
    ...
    preload(key, asset) {
        ...
        if (this.audioType === 'html5') {
            ...
            .catch(error => {
                this.alert.create('Error in preload:' + error + ' ' + key + ' ' + asset);
            });
